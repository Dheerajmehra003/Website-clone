  ...
  return (
    <div className="pt-[60px] flex">
      <div className="flex flex-col gap-3 ml-7 w-[880px] ">
        <iframe
          className="rounded-2xl mt-5 mr-5"
          width="880"
          height="450"
          ...
          allowFullScreen
        ></iframe>
        <h1 className="font-bold text-xl w-[880px]">
        ...
        <div className="flex justify-between w-[880px]">
          ...
          <div className="flex ">
            ...
            <div className="flex gap-2 p-2 items-start">
              <button className="pl-[15px] pr-[15px] pt-[8px]  pb-[8px] rounded-3xl bg-gray-100 font-semibold hover:bg-gray-200">
                Join
              </button>
              <button className="pl-[12px] pr-[12px]  pt-[8px]  pb-[8px]  rounded-3xl bg-black font-semibold text-white hover:bg-gray-800">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="flex flex-col p-3 bg-gray-200 rounded-xl">
          {/* views description */}
          <div className="flex gap-2">
            <p className="font-semibold">100 views</p>
            <p className="font-semibold">4 months ago</p>
          ...
          <div className="mt-2">
            <p className="text-gray-700">{singleVideo?.snippet?.description}</p>
          </div>
        </div>
        <div>{/* comments */}</div> 
      </div>
